...
class Base:
    ...
    def __init__(self, id=None):
        ...
        if id is not None:
            ...
            type(self).__nb_objects += 1   # type(self) vs. Base.__nb?
    ...
    def create(cls, **dictionary):
        ...
        if cls.__name__ is "Rectangle":
            dummy = cls(3, 2)  # 2 are the minimum positional arguments
        elif cls.__name__ is "Square":
            dummy = cls(5)  # 1 is the minimum positional argument
    ...
    def load_from_file(cls):
        ...
        Python list of dictionaries, creates instances with every dict
